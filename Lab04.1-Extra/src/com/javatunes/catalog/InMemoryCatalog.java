...
public class InMemoryCatalog implements Catalog {
    ...
    //Contract methods - these are specified in the Cata log interface and implemented here
    ...
    public Collection<MusicItem> findByKeyword(String keyword) {
        ...
        for (MusicItem currentItem : catalogData) {
            if (currentItem.getTitle().toLowerCase().contains(lowerKeyword)
                    || currentItem.getArtist().toLowerCase().contains(lowerKeyword)) {
    ...
    @Override
    public int size() {
        return catalogData.toArray().length;
    }
    ...
    public Collection<MusicItem> cheapRock(double price) {
        Collection<MusicItem> result = new ArrayList<>();
        for (MusicItem currentItem : catalogData) {
            if((currentItem.getMusicCategory().equals(MusicCategory.ROCK) || currentItem.getMusicCategory().equals(MusicCategory.CLASSIC_ROCK))
